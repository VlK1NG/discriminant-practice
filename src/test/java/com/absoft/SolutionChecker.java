...
public class SolutionChecker {
    ...
    public void testPositiveDiscriminant() {
        ...
        QuadraticEquationSolver.calculateValues(EquationSolverPositiveDisc);
    ...
    public void testNegativeDiscriminant() {
        ...
        Assert.assertNull(QuadraticEquationSolver.calculateValues(EquationSolverPositiveDisc));
    }
